    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "**❌ | لم يتم العثور على محادثة صوتية نشطة**\n\n♻️ | يرجى التأكد من تمكين الدردشة الصوتية للمجموعة. إذا تم التمكين بالفعل ، فالرجاء إنهائه وبدء محادثة صوتية جديدة مرة أخرى وإذا استمرت المشكلة ، فحاول اعاده التشغيل او /restart"
                )
        except AlreadyJoinedError:
            raise AssistantErr(
                "**⚠️ | الحساب المساعد موجود بالفعل في الدردشة الصوتية**\n\n⛔️ | الحساب المساعد موجود بالفعل في الدردشة الصوتية\n\n⚜️ | إذا لم يكن الحساب المساعد موجودًا في الدردشة الصوتية ، فيرجى إنهاء الدردشة الصوتية وبدء محادثة صوتية جديدة مرة أخرى وإذا استمرت المشكلة ، فحاول اعاده التشغيل او /restart"
            )
        except TelegramServerError:
            raise AssistantErr(
                "**🚫 | خطأ فادح في Telegram**\n\n♻️ | يواجه Telegram بعض مشكلات الخادم الداخلي ، يرجى محاولة التشغيل مرة أخرى.\n\n ❕ | إذا استمرت هذه المشكلة في الظهور في كل مرة ، فيرجى إنهاء الدردشة الصوتية وبدء محادثة صوتية جديدة مرة أخرى."
            )
